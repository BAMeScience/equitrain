#!/usr/bin/env python3
"""Benchmark sequential HDF5 read throughput for Equitrain datasets."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='Measure sequential Equitrain HDF5 read throughput.',
    )
    parser.add_argument('path', help='Path to an Equitrain HDF5 file')
    parser.add_argument(
        '--count',
        type=int,
        default=None,
