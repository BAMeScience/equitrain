...
class AniWrapper(AbstractWrapper):
    ...
    def __init__(self, args, model=None, species_order=None):
        ...
        if hasattr(self.model, 'species_converter'):
            ...
            self.species_converter = torchani.utils.ChemicalSymbolsToInts(self._species_order)
        ...
        *args : tuple
        ...
        if self.compute_force:
            forces = -torch.autograd.grad(
                energies.sum(), coordinates, 
                create_graph=True, retain_graph=self.compute_stress
            )[0]
    ...
    def atomic_energies(self):
        ...
        elif hasattr(self.model, 'energy_shifter') and hasattr(self.model.energy_shifter, 'self_energies'):
