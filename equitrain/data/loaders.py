...
def get_dataloaders(args, logger=None):
    ...
    train_loader = get_dataloader(
        args.train_file, args, statistics=statistics, logger=logger
    )
    valid_loader = get_dataloader(
        args.valid_file, args, statistics=statistics, logger=logger
    )
    test_loader = get_dataloader(
        args.test_file, args, statistics=statistics, logger=logger
    )
